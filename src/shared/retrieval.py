...
def make_qdrant_retriever(
    ...
    """Configure this agent to connect to Qdrant."""
    ...
    # Define collection name and vector size (adjust if needed)
    collection_name = "langchain_collection"
    vector_size = 1536

    # Create or recreate the Qdrant collection with the desired configuration
    ...
    # Initialize Qdrant vector store and yield its retriever interface
    vstore = Qdrant(
        client=client,
        collection_name=collection_name,
